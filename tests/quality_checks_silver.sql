...
Objectif du script :
Ce script effectue divers contrôles de qualité pour garantir la cohérence, l’exactitude et la standardisation des données
au sein de la couche « Silver ». Il vérifie notamment :
...
Script Purpose:
  This script performs various quality checks for data consistency, accuracy, and standardisation across the 'silver' layer. It includes checks for:
